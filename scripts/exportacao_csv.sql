...
!!bcp "SELECT A.* FROM ENTIDADES A" queryout [especificar_diretório]\nome_do_arquivo.csv -c -k -t, -T -C -E -S -d [nome_do_banco]
...
-- - query: (SELECT A.* FROM ENTIDADES A) Retorna os dados da tabela ENTIDADES.
...
-- - -t,: Especifica o delimitador de campo como ",".
